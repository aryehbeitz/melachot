...
# After examining the first extraction, refine the values
# The blocks have rounded corners and some padding

# Better margins from edges
left_margin = 43
top_margin = 77
gap_x = 13
gap_y = 15

# Block dimensions (estimated from first extraction)
block_width = 415
block_height = 475
...
# Extract just the first block as a test
name, col, row = melachot_positions[0]
